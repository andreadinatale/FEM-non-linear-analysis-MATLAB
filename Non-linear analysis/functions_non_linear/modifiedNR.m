function [ITERATIONS,niter]=modifiedNR(inc_com,type_material,Kt_unco,Fint_unc,Fext_unc,grad_xsi_eta,Gauss_number,type_SF,lambda_step,ITERATIONS,GEOMETRY,MATERIAL)

 %======================Modified Newton-Raphson iterations========================

    fprintf('MODIFIED NEWTON-RAPHSON ITERATIONS: LAMBDA = %f \n\n',GEOMETRY.lambda_vect(lambda_step))

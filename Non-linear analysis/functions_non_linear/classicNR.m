function [ITERATIONS,niter]=classicNR(inc_com,type_material,Kt_unco,Fint_unc,Fext_unc,grad_xsi_eta,Gauss_number,type_SF,lambda_step,ITERATIONS,GEOMETRY,MATERIAL)

%======================Classic Newton-Raphson iterations========================

    fprintf('CLASSIC NEWTON-RAPHSON ITERATIONS: LAMBDA = %f \n\n',GEOMETRY.lambda_vect(lambda_step))
...
%============Calculate constrained system===============================================
        ...
        [K,Fext,Fint,Delete]=build_constrained_sys(GEOMETRY,Kt_unco,Fint_unc,Fext_unc);
%=======================================================================================
...
%============Calculate stiffneess matricies=================================
        fprintf('Updating stiffness matricies... \n')
        [ITERATIONS,Kt_unco]=build_K(Gauss_number,type_SF,niter+1,ITERATIONS,GEOMETRY);
%===========================================================================    
...
%=========================================================================== 
%============Check the residual=============================================
       [~,Fext,Fint,~]=build_constrained_sys(GEOMETRY,Kt_unco,Fint_unc,Fext_unc);
